...
public class NextRoundTest {
    ...
    private final String[][] gameStates = {
            ...
            new String[]{"BFCB0000060103D1111050511", "A15Ma00c01e02d03b04b12e13a14d20b21a23e24e30c33d34c40S1c12c1FaaafB7Mb00c01e02a04d10b12c14c20e21a23b24d33a40d41c42S3b3Fdddddddd"},
    ...
    private final String[][] endStates = {
            ...
            new String[]{"BFCfB1004061006D0411030308", "A1Me00a01b02c03d04e12c20a22e23b34d40a44S1d12b13c3FB24Md00b01a02c03e04a10e12d14e20b22d23c24d31a43S4c4F"},
            new String[]{"BFCfB0907091213D0006050000", "A5Me00a01c03b04b10e11d12a14d20c21a22b23e24a30d31c32b42c44S4e2FB3Ma00c01e02d04b11d12e13a14d20a22b24c30d31b33a41d43S3a3F"},
            new String[]{"AFCfB0805060805D0609040709", "A28Me01d02c03b04a10d11b12e13c14c20b21d23e30S2e13c14a2FB8Mc00e02a03d04a10e11b12c14c21a22b24d42b43S3c3F"},
            new String[]{"BFCfB0001040100D1212061512", "A0Mc00d02e03a04b10e11c13b22c24a30b31e40d44S1a13c34a1FB12Mc00b01a02d03e04d10b12a13c14e22c23a24e33e41c42b44S1e12b13a1F"},
            new String[]{"AFCfB0000060103D1411051311", "A9Ma00c01e02d03b04b12e13a14d20b21a23e24e30c33d34c40S1c12c1FB0Mb00c01e02a04d10b12c14c20e21a23b24d33a40d41c42S3b3F"},
            new String[]{"BFCfB0703080106D0811031505", "A1Md00a02b03e04d11e13a20c24c30e40S1c12b2FB0Ma00c01b02d03e04c12a13b14d20b21c23a32S1e13c34e4F"},
            new String[]{"AFCfB0606060308D0807091201", "A27Me00a01c02b04d10c11e13a14b20d22a23c24a40S3e24b2FB0Ma00d01b02e04b10a11c12e13d14d23b24c43S3e14e4F"},
            new String[]{"AFCfB0201050507D1313040508", "A0Mb01c02e03a04e10a12b13d21b22c23d30c31c44S1c13b14d4FB3Mc00e01d02b03a04a11d13d20c22a23b24e34d41e43S1c13c14c2F"},
            new String[]{"AFCfB1207080506D0107050809", "A13Md00c01b02a03e04d11a12c13a21c22a30d34a44S2b2FB22Md00c02a03e04a10c11d12e13b14c20e22b23b32c34e40S4d2F"},
    };

    private final String[][] inputStates = {
    ...
    private final String[][] outputStates = {
    ...
    public void testEndOfGameSharedState() {
        for (int i = 0; i < gameStates.length; i++) {
            String[] out = Azul.nextRound(gameStates[i]);
            assertNotNull(out, "Azul.nextRound({\"" + gameStates[i][0] + "\", \"" + gameStates[i][1] + "\"})"
                    + System.lineSeparator()
                    + "returned null");
            ...
            String sharedState = endStates[i][0].substring(1);
    ...
    public void testEndOfGamePlayerStates() {
        for (int i = 0; i < gameStates.length; i++) {
            ...
            String playerA = endStates[i][1].substring(0, endStates[i][1].indexOf('B'));
            String playerB = endStates[i][1].substring(endStates[i][1].indexOf('B'));
            ...
            assertEquals(endStates[i][1], out[1], errorMessagePrefix + "expected playerState to be unchanged because the game has already ended.");
        }
    }
    ...
    public void testNotNextRound() {
        for (int i = 0; i < 13; i++) {
            ...
            String[] out = Azul.nextRound(state);
            assertNotNull(out, "Azul.nextRound({\"" + state[0] + "\", \"" + state[1] + "\"})"
                    + System.lineSeparator()
                    + "returned null");

            String errorMessagePrefix = errorPrefix(state, out);
            assertEquals(state[0], out[0], errorMessagePrefix + "factories were not empty so the round has not finished.");
        }
        String[] state = new String[2];
        ...
        String[] out = Azul.nextRound(state);
        String errorMessagePrefix = errorPrefix(state, out);
        assertNotEquals(state[0], out[0], errorMessagePrefix + "end of round, expected factories to be refilled.");
    }

    @Test
    public void testFloorDeduction() {
        for (int i = 0; i < inputStates.length; i++) {
            String[] out = Azul.nextRound(inputStates[i]);
            assertNotNull(out, "Azul.nextRound({\"" + inputStates[i][0] + "\", \"" + inputStates[i][1] + "\"})"
                    + System.lineSeparator()
                    + "returned null");

            String errorMessagePrefix = errorPrefix(inputStates[i], out);
            ...
            String playerA = outputStates[i][1].substring(0, outputStates[i][1].indexOf('B'));
            String playerB = outputStates[i][1].substring(outputStates[i][1].indexOf('B'));
            int aScore = Integer.parseInt(playerA.substring(1, playerA.indexOf('M')));
            int bScore = Integer.parseInt(playerB.substring(1, playerB.indexOf('M')));
    ...
    public void testCorrectPlayer() {
        for (int i = 0; i < inputStates.length; i++) {
            ...
            char expectedPlayer = outputStates[i][0].charAt(0);
