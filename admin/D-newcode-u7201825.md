...
For Deliverable D2D, I contributed the following new statements of original code:
Added the [isMoveValid](https://gitlab.cecs.anu.edu.au/comp1110/comp1110-ass2/-/blob/master/src/comp1110/ass2/gui/Viewer.java#L47-72) is function to Game class
Added the [testDraw] is function to DrawTilesTest
added the [fullMosaicTest]is function to CalculateBonusScoreTest